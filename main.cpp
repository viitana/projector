...
void createSurface()
{
    ...
    window = glfwCreateWindow(1024, 768, "projector", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    VkResult result = glfwCreateWindowSurface(vk, window, nullptr, &surface);
...
void pickPhysicalDevice()
{
    ...
    std::cout << "Available devices count: " << deviceCount << '\n' << std::flush;
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        vkDestroySurfaceKHR(vk, surface, nullptr);
